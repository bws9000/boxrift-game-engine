...
public class GameState extends AbstractGameState {
    private long lockRequestedAt = -1;
    ...
    *//*public void lockActivePieceAndDisassemble() {
        if (activePiece == null) {
            throw new IllegalStateException("lockActivePieceAndDisassemble called with null activePiece");
        }

        System.out.println("LOCK CALLED at  + activePiece.getOrigin());
